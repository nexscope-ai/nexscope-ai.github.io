...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    mapTitle: 'From China sourcing hubs to target markets',
    mapSummary:
      'Use supplier data to build a shortlist, then verify samples, terms, logistics, and compliance for the destination market.',
    marketNodes: [
      {
        city: 'Hangzhou',
        region: 'East China',
        latitude: 30.27,
        longitude: 120.15,
        role: '1688 digital sourcing ecosystem',
      },
      {
        city: 'Guangzhou',
        region: 'South China',
        latitude: 23.13,
        longitude: 113.26,
        role: 'Wholesale and manufacturing hub',
      },
      {
        city: 'Shenzhen',
        region: 'South China',
      ...
      },
      {
        ...
        latitude: 34.05,
        longitude: -118.24,
        role: 'Destination-market economics',
      },
    ],
  },
];
