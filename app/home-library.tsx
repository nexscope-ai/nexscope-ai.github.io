...
const entries: Entry[] = [
  { title: 'Free Amazon keyword research', description: 'Explore related Amazon keywords, search volume and competition before planning a listing update.', area: 'Product research', kind: 'Tool', href: 'https://www.nexscope.ai/tools/free-amazon-keyword-research-tool?co-from=githubIO', path: 'Keyword → related terms → listing questions', boundary: 'Search metrics are estimates; tool access and coverage may change.' },
  ...
  { title: 'Amazon review analyzer', description: 'Turn a bounded sample of low-star reviews into customer questions worth testing.', area: 'Product research', kind: 'Tool', href: 'https://www.nexscope.ai/tools/amazon-review-analyzer?co-from=githubIO', path: 'Reviews → recurring complaints → testable questions', boundary: 'A review sample cannot represent every customer or prove demand.' },
